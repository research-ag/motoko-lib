...
(()=>{var e=(()=>{"use strict";return e=>{const n=["true","false","null"]
;return{name:"Motoko",aliases:["motoko","mo"],keywords:{
$pattern:"[a-zA-Z_]\\w*",
keyword:["actor","and","async","assert","await","break","case","catch","class","continue","debug","debug_show","do","else","false","flexible","for","from_candid","func","if","ignore","in","import","label","let","loop","module","not","null","object","or","private","public","query","return","shared","stable","switch","system","throw","to_candid","true","try","type","var","while","with"].filter((e=>!n.includes(e)&&"async"!==e)).join(" "),
literal:n.join(" "),
...
contains:["self"]})]}]}}})();hljs.registerLanguage("motoko",e)})();
/*! `candid` grammar compiled for Highlight.js 11.7.0 */
(()=>{var e=(()=>{"use strict";return e=>({name:"Candid",
...
begin:"[+-]?\\b0[xX]([A-Fa-f0-9_]+)"},{
begin:"[+-]?\\b(\\d[\\d_]*(\\.[0-9_]+)?([eE][+-]?[0-9_]+)?)"}],relevance:0}]})
})();hljs.registerLanguage("candid",e)})();